...
layout(set = 4, binding = 0, input_attachment_index = 0) uniform subpassInput attachment_accumulation;
layout(set = 4, binding = 1, input_attachment_index = 1) uniform subpassInput attachment_revealage;
